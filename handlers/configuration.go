...
type Configurations struct {
	...
	UserLocationUrl string `env:"USER_LOCATION_URL" yaml:"USER_LOCATION_URL" env-default:"localhost/error"`
	...
	LocationApiKey  string `yaml:"ACCESS_KEY_LOCATIONAPI" env:"ACCESS_KEY_LOCATIONAPI" env-default:"NA"`
}
